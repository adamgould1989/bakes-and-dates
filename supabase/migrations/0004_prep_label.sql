-- Update create_order_with_events to support per-block labels.
-- If a prep block includes a "label" key, that becomes the calendar event title
-- and is also stored in the notes column for round-trip loading.
-- Otherwise the title falls back to 'Prep: <customer>'.
